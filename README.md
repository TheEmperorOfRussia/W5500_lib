...
- Возвращает 0 при успешной отправке или шаг сбоя
...
- Возвращает 0 при конце отправке (результат отправки проверяется в прерывании) или шаг сбоя
...
- Возвращает 0 при успшном чтении или шаг сбоя  
...
- Возвращает 0 при удачном закрытии или шаг сбоя
...
- Возвращает 0 при удачном отключении или шаг сбоя
