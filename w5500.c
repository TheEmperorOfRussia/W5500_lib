    ...
    W5500_Main_Struct*  MS)
{
    ...
    return 10;  // Ошибка инициализации
}
    ...
    W5500_Main_Struct*  MS)
{
    ...
    return 9;  // Успешная инициализация
}
...
>>>>>>> 3b4b7cf522733b5a0443248b8af90f5d8eec4f41
